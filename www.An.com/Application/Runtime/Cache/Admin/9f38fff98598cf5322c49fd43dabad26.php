  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      ...
      <?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
            ...
            <td><div class="button-group"> <a class="button border-main" href="<?php echo U('edit',['id' => $value['id']]);?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="javascript:shanchu('<?php echo U('delete',['id' => $value['id']]);?>')"><span class="icon-trash-o"></span> 删除</a> </div></td>
